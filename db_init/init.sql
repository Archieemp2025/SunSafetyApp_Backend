...
DROP TABLE IF EXISTS UV_INDEX_STATS CASCADE;
...
CREATE TABLE IF NOT EXISTS UV_INDEX_STAT (
    uv_stat_id SERIAL PRIMARY KEY,
    year INT NOT NULL UNIQUE,
    australian_uv_low FLOAT,
    australian_uv_high FLOAT,
    australian_uv_median FLOAT
);
